...
✔️ Applying for Jobs<br>"
            ...
            new Article
            {
                ...
                Blocks = new List<Block>
                {
                    new Block
                    {
                        Title = "The C# Academy Roadmap",
                        Paragraphs = new List<Paragraph>
                        {
                            new Paragraph
                            {
                                Body = "I’m live proof that a job in technology can be obtained without a college degree. I landed a job as a software engineer at a large Australian company at the age of 39, after learning online for less than two years."
                            },
                            new Paragraph
                            {
                                Body = "One day in 2019, I was exploring possibilities of remote work. I considered language teaching, content creation, personal assistants, and a few other options, but I quickly realised that these fields were already crowded. I needed a highly skilled, high in demand, well-paid profession."
                            },
                            new Paragraph
                            {
                    ...
                    new Block
                    {
                        ...
                        Paragraphs = new List<Paragraph>
                        {
                            ...
                            new Paragraph
                            {
                                Body = "Another criteria is community support. Super common languages such as Java, C#, Javascript and PHP have so many users that most of your questions for the first few years of learning will already have been answered online. And most of the time you’ll be looking for answers in forums, so it pays off to start with a widely-used language."
                            },
                            new Paragraph
                            {
                    ...
                    new Block
                    {
                        ...
                        Paragraphs = new List<Paragraph>
                        {
                            ...
                            new Paragraph
                            {
                                Body = "<b>Start Small</b>: In the process of learning the technologies we talked about above, you’ll be building small applications, using one or a few libraries. These small projects are very important to understand how these things work in isolation. They should definitely be part of your library of projects.   "
                            },
                            new Paragraph
                            {
                            ...
                            new Paragraph
                            {
                                Body = @"In my view, It’s a big mistake to start with complex tutorials. Not only the chances are higher you’ll feel overwhelmed and might end up quitting, but also you might not understand how each piece of the puzzle works before getting them to work in unison. "
                            },
                            new Paragraph
                            {
